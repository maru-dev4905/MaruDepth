window.addEventListener("load",()=>{
    ...
    function create__card(name, text, link, tags){
        ...
        imgBox.classList.add("site__img");
        ...
        contentBox.classList.add("site__content");

        const strong = document.createElement("strong");
        strong.classList.add("site--title");
        strong.innerText = name;

        const p = document.createElement("p");
        p.classList.add("site--desc");
        p.innerText = text;

        const a2 = document.createElement("a");
        a2.classList.add("site--link");
        a2.setAttribute("href",link);
        a2.setAttribute("target","_blank");
        a2.innerText = "Go to Site";

        const span = document.createElement("span");
        span.classList.add("sr");
        span.classList.add("site--tags");
        span.innerText = tags;
